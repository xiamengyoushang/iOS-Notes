...
static void SimpleObjectExample(){
    ...
    YYBook *book = [YYBook modelWithJSON:jsonString];
...
static void NestObjectExample(){
    ...
    YYRepo *repo = [YYRepo modelWithJSON:jsonString];
...
static void ContainerObjectExample(){
    ...
    YYAlbum *album = [YYAlbum modelWithJSON:jsonString];
...
static void CustomMapperExample() {
    NSString *jsonString = @"{\"i\":\"2000000001\",\"c\":\"Hello\",\"t\":\"1437237598000\"}";
    YYMessage *message = [YYMessage modelWithJSON:jsonString];
