    ...
    switch (routeAnnotation.type) {
        case 0:
        {
            ...
            if (view == nil) {
                ...
                view.image = [UIImage imageWithContentsOfFile:[self getMyBundlePath:@"images/icon_nav_start"]];
        ...
        case 1:
        {
            ...
            if (view == nil) {
                ...
                view.image = [UIImage imageWithContentsOfFile:[self getMyBundlePath:@"images/icon_nav_end"]];
                view.centerOffset = CGPointMake(0, -(view.frame.size.height * 0.5));
                view.canShowCallout = true;
            }
            view.annotation =routeAnnotation;
        ...
        case 4:
        {
            ...
            UIImage *image = [UIImage imageWithContentsOfFile:[self getMyBundlePath:@"images/icon_direction"]];
